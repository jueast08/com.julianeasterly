<template>
  ...
  <g class="main">
    <path class="arrow-class" d="M25.292,34.603l16.968-9.044l-16.426-9.836c2.101,2.456,3.377,5.648,3.377,9.14
      C29.211,28.648,27.717,32.071,25.292,34.603z"/>
    <path class="direction-class" d="M38.624,38.466l4.355,4.354l0,0c9.664-9.665,9.759-25.274,0.288-35.058l-4.357,4.356
